...
export default function Cart(){
  ...
  return <>
    <section className="commerce-hero cart-hero"><div className="wrap commerce-hero-inner"><div><div className="eyebrow light">YOUR TORDHER BITES ORDER</div><h1>YOUR BAG.<br/><span>YOUR CRAVING.</span></h1><p>Fine-tune your order, add another favourite, then send it straight to the kitchen.</p></div><div className="commerce-hero-stat"><small>IN YOUR CART</small><strong>{count}</strong><span>{count===1?'item':'items'} ready for checkout</span></div></div></section>
